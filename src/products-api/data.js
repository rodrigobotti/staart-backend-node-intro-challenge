...
const spirits = [
  ...
  },
  {
    ...
    price: 7.83,
    description:
      'Illo itaque animi at maxime recusandae voluptate corporis nobis aut.',
  },
  {
...
const softDrinks = [
  ...
  },
  {
    ...
    price: 1.87,
    description:
      'Ut dolorem dolor recusandae suscipit sunt error ratione voluptas.',
  },
  {
...
const snacks = [
  {
    ...
    price: 2.55,
    description:
      'Pariatur consectetur sapiente quae aliquid ipsa blanditiis earum veniam.',
  },
  {
  ...
  },
  {
    ...
    price: 4.47,
    description:
      'Blanditiis iusto animi quia et incidunt soluta inventore et molestiae.',
  },
  {
    ...
    price: 2.6,
    description:
      'Cupiditate laboriosam fugiat quos numquam dolor qui consequatur.',
  },
  {
    ...
    price: 9.77,
    description:
      'Harum optio qui distinctio beatae aut occaecati animi eligendi accusamus.',
  },
]

const allProducts = [...beers, ...wines, ...spirits, ...softDrinks, ...snacks]

const withoutDetail = (products) =>
...
const productsById = allProducts.reduce(
  (table, product) => ({ ...table, [product.id]: product }),
  {}
)
